...
#define MAX_VERTS 50000  /* maximum number of polyhedral vertices */
#define MAX_FACES 50000  /* maximum number of polyhedral faces */
#define MAX_POLYGON_SZ 4 /* maximum number of verts per polygonal face */
...
void readPolyhedron(char *name, POLYHEDRON *p)
{
    ...
    for (i = 0; i < p->numVerts; i++)
        fscanf(fp, "%lf %lf %lf", &p->verts[i][X], &p->verts[i][Y],
               &p->verts[i][Z]);
